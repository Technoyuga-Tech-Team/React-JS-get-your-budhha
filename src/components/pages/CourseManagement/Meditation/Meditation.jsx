...
import { getMeditationApi, deleteMeditation, UpdateIndexingApi } from "../../../../services/meditation"
...
function Meditation2() {
    ...
    useEffect(() => {
        ...
        setIsOrderChanged(!originalOrder.every((item, index) => Meditation[index] === item));
                                        ...
                                        <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                            ...
                                            <div className="page-title-right">
                                                <ol className="breadcrumb m-0">
                                                    <li className="breadcrumb-item" style={{ cursor: 'pointer' }} onClick={() => navigate('/stage', {
                                                ...
                                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: "15px" }}>
                                                    ...
                                                    <div className="d-flex flex-row">
                                                        ...
                                                        <div className="d-grid">
                                                            <button className="btn btn-primary waves-effect waves-light" type="buttom" onClick={() => onClickAddMeditation(true)} >Add Meditation</button>
                                                        </div>
